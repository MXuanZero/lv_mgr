...
The first item will have one unit of space against the container edge, but two units of space between the tail item because that tail item has its own spacing that applies. Not applies to `track_cross_place`.
