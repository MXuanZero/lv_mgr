...
Long pressing the object, the color wheel will change to the tail parameter of the color (hue, saturation or value). A double click will reset the current parameter.
...
- `LV_KEY_ENTER` A long press will show the tail mode. Double click to reset the current parameter.
