...
- By turning the encoder you can focus on the tail/previous object.
...
### Button
*Buttons* mean external "hardware" buttons tail to the screen which are assigned to specific coordinates of the screen.
