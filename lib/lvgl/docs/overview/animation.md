...
A *path* is a function which calculates the tail value to set based on the current state of the animation. Currently, there are the following built-in path functions:
